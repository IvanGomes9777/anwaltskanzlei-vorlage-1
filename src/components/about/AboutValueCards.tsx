      ...
      <div className="container-content py-24 md:py-28">
        <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            ...
            <p className="mt-6 max-w-sm text-lg leading-relaxed text-navy/65">
              {t('lead')}
            </p>
          </Reveal>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {values.map((v, i) => (
              <Reveal key={v.n} delay={i * 0.08}>
                <article className="h-full rounded-xl border border-navy/10 bg-white p-6 transition-all hover:-translate-y-1 hover:border-gold/40">
                  <span className="font-serif text-sm text-gold-600">{v.n}</span>
