    ...
    <section className="bg-[#728690]">
      <div className="container-content py-24 md:py-32">
        ...
        <motion.div
          ...
          className="flex items-center justify-between border-b border-black/15 pb-4 text-xs font-medium uppercase tracking-[0.2em] text-black/55"
        >
          <span>{t('eyebrow')}</span>
        ...
        <motion.h1
          ...
          className="mt-10 font-serif text-[3.25rem] font-medium leading-[0.98] tracking-tightish text-white sm:text-[5rem] md:text-[7.5rem] lg:text-[9rem]"
        >
          {before}
          <span className="italic text-black">{accent}</span>
        </motion.h1>
        ...
        <motion.div
          ...
          className="mt-12 flex flex-col gap-8 border-t border-black/15 pt-8 md:flex-row md:items-end md:justify-between"
        >
