  ...
  return (
    <section className="relative overflow-hidden bg-[#728690] text-black">
      <div
        ...
        style={{
          background:
            'radial-gradient(55% 55% at 15% 0%, rgba(114,134,144,0.16) 0%, transparent 60%)',
        }}
      />
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {members.map((m, i) => (
            <Reveal key={m.name} delay={i * 0.08}>
              <article className="group rounded-xl border border-black/12 bg-[#728690]/[0.03] p-3 transition-colors hover:border-white/40">
