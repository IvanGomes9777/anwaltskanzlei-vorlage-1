...
export default function HeroTwoTone() {
  ...
  return (
    <section className="grid md:grid-cols-2">
      {/* Navy-Hälfte: Claim */}
      <div className="relative flex items-center bg-[#728690] px-6 py-20 text-black md:px-12 md:py-32">
        <div className="ml-auto w-full max-w-md">
          ...
          <motion.dl
            ...
            className="mt-12 grid grid-cols-2 gap-6 border-t border-black/15 pt-6"
          >
            {stats.map((s) => (
              <div key={s.l}>
      ...
      <div className="relative flex items-center bg-[#728690] px-6 py-20 md:px-12 md:py-32">
        <span aria-hidden className="absolute left-0 top-1/2 hidden h-24 w-1 -translate-y-1/2 bg-white md:block" />
