...
export default async function ServicesVariantsPage({
  params,
}: {
...
function Gallery() {
  const t = useTranslations('variantsSvc');

  const variants = [
    { id: 'v1', name: t('v1Name'), desc: t('v1Desc'), node: <ServicesCards /> },
    { id: 'v2', name: t('v2Name'), desc: t('v2Desc'), node: <ServicesList /> },
    { id: 'v3', name: t('v3Name'), desc: t('v3Desc'), node: <ServicesBento /> },
    { id: 'v4', name: t('v4Name'), desc: t('v4Desc'), node: <ServicesSplit /> },
    { id: 'v5', name: t('v5Name'), desc: t('v5Desc'), node: <ServicesDark /> },
  ];
