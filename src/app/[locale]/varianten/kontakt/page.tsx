...
function Gallery() {
  const t = useTranslations('variantsContact');

  const variants = [
    { id: 'v1', name: t('v1Name'), desc: t('v1Desc'), node: <ContactSplit /> },
    { id: 'v2', name: t('v2Name'), desc: t('v2Desc'), node: <ContactCentered /> },
    { id: 'v3', name: t('v3Name'), desc: t('v3Desc'), node: <ContactDark /> },
    { id: 'v4', name: t('v4Name'), desc: t('v4Desc'), node: <ContactMap /> },
    { id: 'v5', name: t('v5Name'), desc: t('v5Desc'), node: <ContactTiles /> },
  ];
