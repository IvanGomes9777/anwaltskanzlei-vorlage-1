...
import ReviewsQuote from '@/components/reviews/ReviewsQuote';
import ReviewsDark from '@/components/reviews/ReviewsDark';

export default async function ReviewsVariantsPage({
  params,
}: {
...
function Gallery() {
  const t = useTranslations('variantsReviews');

  const variants = [
    { id: 'v1', name: t('v1Name'), desc: t('v1Desc'), node: <ReviewsGrid /> },
    { id: 'v2', name: t('v2Name'), desc: t('v2Desc'), node: <ReviewsMarquee /> },
    { id: 'v3', name: t('v3Name'), desc: t('v3Desc'), node: <ReviewsAggregate /> },
    { id: 'v4', name: t('v4Name'), desc: t('v4Desc'), node: <ReviewsQuote /> },
    { id: 'v5', name: t('v5Name'), desc: t('v5Desc'), node: <ReviewsDark /> },
  ];
