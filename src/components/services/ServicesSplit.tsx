    ...
    <section className="bg-[#728690]">
      <div className="container-content grid gap-12 py-24 md:grid-cols-[0.85fr_1.15fr] md:py-28">
        ...
        <div className="md:sticky md:top-28 md:h-fit">
          ...
          <p className="mt-5 max-w-sm text-lg text-black/65">{s('intro')}</p>
          <a
            href="#"
        ...
        <div>
          {items.map((it, i) => (
            <Reveal key={it.n} delay={i * 0.08}>
              <div className="border-t border-black/12 py-8 first:border-t-0 first:pt-0">
                ...
                <p className="mt-3 pl-8 text-base leading-relaxed text-black/65">
                  {it.desc}
                </p>
              </div>
            </Reveal>
